...
const Login = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center'>
      <div className='rounded-xl w-4/5 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
            ...
            <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
              ...
              <Form onFinish={onFinish}>
                ...
                <div className='mb-5'>
                  <button
                    type='submit'
                    className='w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-xl text-white transition hover:bg-opacity-90'
                  >
                    Đăng nhập
                  </button>
                </div>
